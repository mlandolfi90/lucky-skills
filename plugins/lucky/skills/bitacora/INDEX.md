...
| Agregaste un workflow de CI con `schedule:` (cron) y jamás corre — 0 runs, sin error visible | GAP | Los cron de Actions corren SOLO desde la rama default; repo dev-only → el periódico va a un scheduler externo, NO a Actions | [GAP-002](entries/GAP-002.md) | 2026-07-01 | 1 | CANDIDATE |
