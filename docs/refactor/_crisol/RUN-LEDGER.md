...
- ITER-2: FAIL de CREDITO del scope-verifier (iter 1) → depositado ADR 0017 "Escalera de calidad: peldaños 0-3" (entrada default, tope preguntado, sin saltos + excepción 1→3, TARGET por peldaño, puente de gate Fase 1→2, tablas) + esta línea de MIGRATION_STRATEGY reescrita por su observación menor.
<!-- VEREDICTOS:BEGIN -->
- runState: wip
<!-- VEREDICTOS:END -->
- Iteraciones: 2/3
